...
EEVE-10.8b 모델을 베이스 모델로 사용하였습니다. 모델의 훈련 데이터는 이전 polyglot 베이스 모델과 동일한 데이터를 사용하였습니다. 챗봇에 훈련에 맞는 데이터로 변환해 미세조정하였습니다.

EEVE모델은 한국어, 영어 중심 모델이며, RAG 프롬프트에 대응할 수 있는 모델입니다.
...
이후 RAG 데이터는 던전앤파이터 인게임 정보와 스토리 데이터를 추가해볼 예정입니다.
